...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let products: Vec<LineItem> = vec![
        LineItem {id:1, name: "test1".to_string(), sku: "2116116".to_string(), barcode: "840276159107".to_string(), quantity: 5, price: 13.95, discount: 0.0 },
        LineItem {id:1, name: "test1".to_string(), sku: "2116114".to_string(), barcode: "840276159084".to_string(), quantity: 1, price: 13.95, discount: 0.0 },
    ];
